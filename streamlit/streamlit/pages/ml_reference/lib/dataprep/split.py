...
from pages.ml_reference.lib.dataprep.clean import clean_future_df
from pages.ml_reference.lib.dataprep.format import prepare_future_df
from pages.ml_reference.lib.utils.mapping import convert_into_nb_of_days, convert_into_nb_of_seconds
...
def get_train_end_date_default_value(
    ...
    if use_cv:
        ...
        default_end = pd.to_datetime('2023-07-01')
    else:
