...
JSON_EXTRACT_STRING_ARRAY(subtotal_items, "$.item_data.order_custom_discount_items.order_discounted_price") as order_custom_discount_items_order_discounted_price,
...
array_agg(
  struct(
    ...
    order_custom_discount_items_order_discounted_price,
    discounted_price,
    created_by
  )) items
from orders_detail
